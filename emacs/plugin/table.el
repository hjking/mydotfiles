...
;; Revised:       Fri Jul 12 2002 21:45:52 (PDT)
...
(defvar table-fixed-mode-indicator nil
  "For mode line indicator")
(defconst table-source-languages '(html latex tei cals csv)
...
structure of the table.  It must be either 'html, 'latex, 'tei, 'cals
or 'csv.  The resulted source text is inserted into DEST-BUFFER and
the buffer object is returned.  When DEST-BUFFER is omitted or nil the
...
Currently this method is for LaTeX and CSV."
