...
hi Normal ctermfg=White guifg=White guibg=#000000

hi SpecialKey term=bold ctermfg=darkblue guifg=Yellow
hi NonText term=bold ctermfg=darkblue cterm=bold gui=bold guifg=#7f7f7f guibg=#36648b
...
hi Search term=reverse ctermbg=White ctermfg=Black cterm=reverse guibg=#606300 guifg=#FF1212
...
hi FoldColumn term=standout ctermfg=darkblue ctermbg=grey guifg=#ffff74 guibg=#c4153b
...
hi Comment term=bold ctermfg=darkblue guifg=#22a21f			" gui=italic
...
hi Statement term=bold ctermfg=darkred cterm=bold gui=bold guifg=#eee840
hi PreProc term=underline ctermfg=darkmagenta guifg=#00b098
